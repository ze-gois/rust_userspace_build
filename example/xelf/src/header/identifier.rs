...
//         let file_descriptor = common::file::open_path(filepath);
...
//     ) -> core::result::Result<crate::dtype::EnumTyped, crate::dtype::Error> {
//         let endianness = Endianness::LSB;

//         common::file::seek(file_descriptor, 0);
...
//         Class::from(self.class.0)
//     }

//     pub fn get_endianness(&self) -> Endianness {
//         Endianness::from(self.endianness.0)
//     }
...
//             ",
//             self.class,
//             crate::dtype::Endianness::from(self.endianness.0),
//             self.copy_version(),
//             self.osabi,
