...
#[inline(always)]
#[rustfmt::skip]
pub fn syscall6(n: usize, a1: usize, a2: usize, a3: usize, a4: usize, a5: usize, a6: usize)-> crate::Result {
    ...
    if (result as isize) < 0 {
        Err(crate::target::Error::Arch(
            crate::target::arch::Error::X86_64Syscall(
                crate::target::arch::syscall::Error::X86_64Syscall6(Error::Default(result)),
            ),
        ))
    } else {
        Ok(crate::target::Ok::Arch(
            crate::target::arch::Ok::X86_64Syscall(
                crate::target::arch::syscall::Ok::X86_64Syscall6(Ok::Default(result)),
            ),
        ))
    }
}
