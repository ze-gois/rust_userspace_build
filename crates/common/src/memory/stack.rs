...
#[derive(Debug)]
pub struct Stack {
    pub former: target::arch::Pointer,
    pub latter: target::arch::Pointer,
    // pub size: usize,
...
impl Stack {
    pub fn from_pointer(stack_pointer: target::arch::Pointer) -> Self {
    ...
    pub fn current() -> Self {
        Self::from_pointer(target::arch::Pointer::current())
    }
